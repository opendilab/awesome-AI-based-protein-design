# Contributing to Awesome AI based Protein Design

Anyone interested in AI based Protein Design is welcomed to contribute to this repo:
...
2. Clone this repo to your own machine.
    ```
    git clone https://github.com/<your_username>/awesome-AI-based-protein-design.git
    ```
...
- Now commit those changes using the `git commit` command:
    ...
    * `For example:` add(yf): add one paper about xxFold on #nature 2022
